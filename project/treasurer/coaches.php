...
<html>
	...
	<body>
		...
		<div class="topnav">
			...
			<a class="active" href="coaches.php">Manage Coaches</a>
		...
		<div class="tab">
		  <button class="tablinks" onclick="openTab(event, 'Add Coaches')" id="defaultOpen">Add Coaches</button>
		  <button class="tablinks" onclick="openTab(event, 'Delete Coaches')">Delete Coaches</button>
		</div>

		<div id="Add Coaches" class="tabcontent">	
		<h2>Coach List</h2>			    
		 	<table style="width:50%">
				...
				<?php
				$sql = "SELECT * FROM userinfos WHERE account= 2";
		...
		<div id="Delete Coaches" class="tabcontent">
			<h2>Coach List</h2>
			<table style="width:50%;">
				<tr>
					<th> UID </th>
    		...
    		<br>
   			<br>
    		<form action="deleteFunction2.php?uid=<?php echo $_POST['number'];?>">
          		<fieldset>
            		<legend>Enter a coaches UID to delete them.</legend>
            		Coach UID:<br>
